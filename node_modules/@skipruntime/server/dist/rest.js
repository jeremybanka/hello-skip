...
export function controlService(service) {
    const app = express();
    ...
    app.post("/v1/streams/:resource", (req, res) => {
        try {
            ...
            service.instantiateResource(uuid, req.params.resource, req.body);
    ...
    app.post("/v1/snapshot/:resource", (req, res) => {
        try {
            ...
            service.getAll(req.params.resource, req.body, callbacks);
        }
        catch (e) {
            console.log(e);
            res.status(500).json(e instanceof Error ? e.message : e);
    ...
    app.post("/v1/snapshot/:resource/lookup", (req, res) => {
        try {
            ...
            if (typeof req.body != "object" ||
                !("key" in req.body) ||
                !("params" in req.body))
                throw new Error(`Invalid request body for synchronous lookup: ${JSON.stringify(req.body)}`);
            service.getArray(req.params.resource, req.body.key, req.body.params, callbacks);
        }
        catch (e) {
            console.log(e);
            res.status(500).json(e instanceof Error ? e.message : e);
    ...
    app.patch("/v1/inputs/:collection", (req, res) => {
        ...
        try {
            service.update(req.params.collection, req.body);
            res.sendStatus(200);
        }
        catch (e) {
...
export function streamingService(service) {
    const app = express();
