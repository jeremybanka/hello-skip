 ...
 */
export declare function runService<Inputs extends NamedCollections, ResourceInputs extends NamedCollections>(service: SkipService<Inputs, ResourceInputs>, options?: {
