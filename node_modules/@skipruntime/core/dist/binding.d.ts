...
import { type CollectionUpdate, type ExternalService, type LazyCompute, type Mapper, type Reducer, type Resource, type SkipService } from "@skipruntime/api";
export type Handle<T> = Internal.Opaque<number, {
    handle_for: T;
}>;
export declare class ResourceBuilder {
    private readonly builder;
    constructor(builder: new (params: Json) => Resource);
...
export interface FromBinding {
    ...
    SkipRuntime_Runtime__createResource(identifier: string, resource: string, jsonParams: Pointer<Internal.CJObject>): Handle<Error>;
    SkipRuntime_Runtime__getAll(resource: string, jsonParams: Pointer<Internal.CJObject>, request: Pointer<Internal.Request> | null): Pointer<Internal.CJObject | Internal.CJFloat>;
    SkipRuntime_Runtime__getForKey(resource: string, jsonParams: Pointer<Internal.CJObject>, key: Pointer<Internal.CJSON>, request: Pointer<Internal.Request> | null): Pointer<Internal.CJObject | Internal.CJFloat>;
    ...
    SkipRuntime_Context__useExternalResource(service: string, identifier: string, params: Pointer<Internal.CJObject>): string;
