...
export type LHandle<K extends T<any> = CJSON, V extends T<any> = CJSON> = T<typeof lhandle> & {
    [p]: (_: V) => K;
};
declare const nonemptyiterator: unique symbol;
export type NonEmptyIterator<Ty extends T<any> = CJSON> = T<typeof nonemptyiterator> & {
    [p]: Ty;
};
